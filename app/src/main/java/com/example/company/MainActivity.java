        ...
        switch (v.getId()) {
                ...
                if (logCursor.moveToFirst()) {
                    ...
                    do {
                        if (login.getText().toString().equals(logCursor.getString(loginIndex)) && password.getText().toString().equals(logCursor.getString(passwordIndex))) {
                            logged = false;
                            int quantityIndex = logCursor.getColumnIndex(DBHelper.KEY_QUANTITY);
                            ContentValues contentValues = new ContentValues();
                            contentValues.put(DBHelper.KEY_QUANTITY, Integer.valueOf(logCursor.getString(quantityIndex)) + 1);
            ...
            case R.id.btnReg:
                ...
                if (reg) {
                    ...
                    contentValues.put(DBHelper.KEY_QUANTITY, 0);
